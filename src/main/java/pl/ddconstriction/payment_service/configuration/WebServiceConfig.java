package pl.ddconstriction.payment_service.configuration;
...
public class WebServiceConfig extends WsConfigurerAdapter {
    ...
    public DefaultWsdl11Definition defaultWsdl11Definition(XsdSchema paymentSchema) {
        ...
        wsdl11Definition.setTargetNamespace("http://example.com/soap/api");
    ...
    public XsdSchema paymentSchema() {
        return new SimpleXsdSchema(new ClassPathResource("xsd/requests.xsd"));
    }
}