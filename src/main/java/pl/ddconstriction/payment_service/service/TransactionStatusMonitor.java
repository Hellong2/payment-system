...
public class TransactionStatusMonitor {
    ...
    public TransactionStatusMonitor(PaymentTransactionRepository transactionRepository, TransactionEventPublisher eventPublisher) {
        this.transactionRepository = transactionRepository;
        this.eventPublisher = eventPublisher;
    }

    static final Logger log = LoggerFactory.getLogger(TransactionStatusMonitor.class);
